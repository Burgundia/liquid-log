...
public class Constants
{
    ...
    public static class PerformedActions
    {
        ...
        public static final String CATALOG_ACTIONS = "catalogActions";
        ...
        static List<String> getProps()
        {
            return Lists.newArrayList(TIME, ADD_ACTIONS, EDIT_ACTIONS, CATALOG_ACTIONS, LIST_ACTIONS, COMMENT_ACTIONS, ACTIONS_COUNT,
